...
class DatePage extends StatefulWidget {
  ...
  DatePage({required this.userKey, required this.currentDateWithoutTime});
...
class _DatePageState extends State<DatePage> {
  // ใช้โค้ดเดียวกันกับคลาส _HomePageState แต่แทนที่ DateTime.now() ด้วย widget.previousDateWithoutTime ใน getData ฟังก์ชัน
  String name = '';
  int TG_cal = 0;
  int TG_pro = 0;
  int TG_carb = 0;
